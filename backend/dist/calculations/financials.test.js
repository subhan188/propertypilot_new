import { calculateNOI, calculateCapRate, calculateCashOnCash, calculateROI, calculateFlipProfit, mortgageAmortizationSchedule, estimateARV, calculateCAGR, calculateBreakEvenMonths, calculateIRR, calculateNPV, sensitivityAnalysis, } from './financials';
describe('Financial Calculations', () => {
    ...
    describe('calculateFlipProfit', () => {
        it('should calculate flip profit correctly', () => {
            const profit = calculateFlipProfit(300000, // purchase
            50000, // rehab
            10000, // closing
            450000, // sale
            20000 // selling
        ...
        it('should account for holding costs', () => {
            const profit = calculateFlipProfit(300000, 50000, 10000, 450000, 20000, 5000 // holding
            );
            // 450,000 - (300,000 + 50,000 + 10,000 + 5,000 + 20,000) = 65,000
            expect(profit).toBe(65000);
        });
        it('should handle loss scenario', () => {
            const profit = calculateFlipProfit(300000, 100000, 20000, 350000, 30000);
    ...
    describe('sensitivityAnalysis', () => {
        it('should perform sensitivity analysis', () => {
            ...
            const salePriceScenario = analysis.scenarios.find((s) => s.variable === 'salePrice');
        ...
        it('should show impact of 20% variation', () => {
            ...
            const salePriceScenario = analysis.scenarios.find((s) => s.variable === 'salePrice');
            const baseProfitDifference = Math.abs(salePriceScenario.upPercent - salePriceScenario.downPercent);
    ...
    describe('Integration - Combined Calculations', () => {
        ...
        it('should calculate metrics for a flip property', () => {
            ...
            const profit = calculateFlipProfit(purchasePrice, rehabCost, closingCosts, salePrice, sellingCosts, holdingCosts);
            const totalInvestment = purchasePrice + rehabCost + closingCosts + holdingCosts;
        ...
        it('should calculate amortization for a 30-year mortgage', () => {
            ...
            const months = 360;
            const schedule = mortgageAmortizationSchedule(loanAmount, interestRate, months);
            const totalInterestPaid = schedule.reduce((sum, entry) => sum + entry.interest, 0);
...
//# sourceMappingURL=financials.test.js.map