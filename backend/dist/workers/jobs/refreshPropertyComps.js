...
export async function refreshPropertyCompsHandler(data) {
    ...
    try {
        ...
        // Fetch comparables
        const comparables = await adapter.getComparables(property.address, property.city, property.state, property.sqft || 1000, radius);
        ...
        // Create new comps
        const createdComps = await Promise.all(comparables.map((comp) => prisma.comp.create({
            data: {
                propertyId,
...
//# sourceMappingURL=refreshPropertyComps.js.map